...
{
    public class SvcCrosshairAngle : Message
    {
        public override MessageIds Id
        {
            get { return MessageIds.SVC_CrosshairAngle; }
        }

        public override MessageIds_Protocol36 Id_Protocol36
        {
            get { return MessageIds_Protocol36.SVC_CrosshairAngle; }
        }

        public override string Name
        {
            get { return "SVC_CrosshairAngle"; }
        }
